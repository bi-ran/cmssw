...
# akPuSoftDrop3Caloparton = patJetPartonMatch.clone(
#     src = cms.InputTag("akPuSoftDrop3CaloJets")
# )
...
akPuSoftDrop3CaloJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPuSoftDrop3CaloJets'))

# akPuSoftDrop3Caloclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak3HiCleanedGenJets'))

# akPuSoftDrop3CalobTagger = bTaggers(
#     "akPuSoftDrop3Calo", 0.3)
...
# akPuSoftDrop3CaloPatJetFlavourId = cms.Sequence(
#     akPuSoftDrop3CaloPatJetPartons
#     *
#     akPuSoftDrop3CaloPatJetFlavourAssociation)

# akPuSoftDrop3CaloJetBtaggingIP  = cms.Sequence(
#     akPuSoftDrop3CaloImpactParameterTagInfos *
...
# akPuSoftDrop3CaloJetBtaggingSV = cms.Sequence(
#     akPuSoftDrop3CaloImpactParameterTagInfos
#     *
...
# )
# 
# akPuSoftDrop3CaloJetBtaggingNegSV = cms.Sequence(
#     akPuSoftDrop3CaloImpactParameterTagInfos
#     *
...
# )
# 
# akPuSoftDrop3CaloJetBtaggingMu = cms.Sequence(
#     akPuSoftDrop3CaloSoftPFMuonsTagInfos
#     *
#     akPuSoftDrop3CaloSoftPFMuonBJetTags
#     +
...
# )
# 
# akPuSoftDrop3CaloJetBtagging = cms.Sequence(
#     akPuSoftDrop3CaloJetBtaggingIP
#     *
...
akPuSoftDrop3CalopatJetsWithBtagging = patJets.clone(
    jetSource              = cms.InputTag("akPuSoftDrop3CaloJets"),
...
#         cms.InputTag("akPuSoftDrop3CaloSimpleSecondaryVertexHighEffBJetTags"),
...
#     'akPuSoftDrop3CaloNjettiness:tau1',
#     'akPuSoftDrop3CaloNjettiness:tau2',
...
akPuSoftDrop3CaloJetSequence_mc = cms.Sequence(
    ...
    *
    ...
    # akPuSoftDrop3CaloPatJetFlavourId
    # *
...
akPuSoftDrop3CaloJetSequence_data = cms.Sequence(
    akPuSoftDrop3Calocorr
    *
    # akPuSoftDrop3CaloJetID
    # *
...
akPuSoftDrop3CaloJetSequence_jec = cms.Sequence(
    akPuSoftDrop3CaloJetSequence_mc)
akPuSoftDrop3CaloJetSequence_mb = cms.Sequence(
    akPuSoftDrop3CaloJetSequence_mc)

akPuSoftDrop3CaloJetSequence = cms.Sequence(
    akPuSoftDrop3CaloJetSequence_mb)

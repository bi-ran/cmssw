...
# akSoftDrop4Caloparton = patJetPartonMatch.clone(
#     src = cms.InputTag("akSoftDrop4CaloJets")
# )
...
akSoftDrop4CaloJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akSoftDrop4CaloJets'))

# akSoftDrop4Caloclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak4HiCleanedGenJets'))

# akSoftDrop4CalobTagger = bTaggers(
#     "akSoftDrop4Calo", 0.4)
...
# akSoftDrop4CaloPatJetFlavourId = cms.Sequence(
#     akSoftDrop4CaloPatJetPartons
#     *
#     akSoftDrop4CaloPatJetFlavourAssociation)

# akSoftDrop4CaloJetBtaggingIP  = cms.Sequence(
#     akSoftDrop4CaloImpactParameterTagInfos *
...
# akSoftDrop4CaloJetBtaggingSV = cms.Sequence(
#     akSoftDrop4CaloImpactParameterTagInfos
#     *
...
# )
# 
# akSoftDrop4CaloJetBtaggingNegSV = cms.Sequence(
#     akSoftDrop4CaloImpactParameterTagInfos
#     *
...
# )
# 
# akSoftDrop4CaloJetBtaggingMu = cms.Sequence(
#     akSoftDrop4CaloSoftPFMuonsTagInfos
#     *
#     akSoftDrop4CaloSoftPFMuonBJetTags
#     +
...
# )
# 
# akSoftDrop4CaloJetBtagging = cms.Sequence(
#     akSoftDrop4CaloJetBtaggingIP
#     *
...
akSoftDrop4CalopatJetsWithBtagging = patJets.clone(
    jetSource              = cms.InputTag("akSoftDrop4CaloJets"),
...
#         cms.InputTag("akSoftDrop4CaloSimpleSecondaryVertexHighEffBJetTags"),
...
#     'akSoftDrop4CaloNjettiness:tau1',
#     'akSoftDrop4CaloNjettiness:tau2',
...
akSoftDrop4CaloJetSequence_mc = cms.Sequence(
    ...
    *
    ...
    # akSoftDrop4CaloPatJetFlavourId
    # *
...
akSoftDrop4CaloJetSequence_data = cms.Sequence(
    akSoftDrop4Calocorr
    *
    # akSoftDrop4CaloJetID
    # *
...
akSoftDrop4CaloJetSequence_jec = cms.Sequence(
    akSoftDrop4CaloJetSequence_mc)
akSoftDrop4CaloJetSequence_mb = cms.Sequence(
    akSoftDrop4CaloJetSequence_mc)

akSoftDrop4CaloJetSequence = cms.Sequence(
    akSoftDrop4CaloJetSequence_mb)

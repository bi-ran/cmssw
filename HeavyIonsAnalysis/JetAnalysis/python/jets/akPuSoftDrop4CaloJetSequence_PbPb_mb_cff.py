...
# akPuSoftDrop4Caloclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak4HiCleanedGenJets'))

# akPuSoftDrop4CalobTagger = bTaggers(
#     "akPuSoftDrop4Calo", 0.4)
...
# akPuSoftDrop4CaloPatJetFlavourId = cms.Sequence(
#     akPuSoftDrop4CaloPatJetPartons
#     *
#     akPuSoftDrop4CaloPatJetFlavourAssociation)

# akPuSoftDrop4CaloJetBtaggingIP  = cms.Sequence(
#     akPuSoftDrop4CaloImpactParameterTagInfos *
...
# akPuSoftDrop4CaloJetBtaggingSV = cms.Sequence(
#     akPuSoftDrop4CaloImpactParameterTagInfos
#     *
...
# )
# 
# akPuSoftDrop4CaloJetBtaggingNegSV = cms.Sequence(
#     akPuSoftDrop4CaloImpactParameterTagInfos
#     *
...
# )
# 
# akPuSoftDrop4CaloJetBtaggingMu = cms.Sequence(
#     akPuSoftDrop4CaloSoftPFMuonsTagInfos
#     *
#     akPuSoftDrop4CaloSoftPFMuonBJetTags
#     +
...
# )
# 
# akPuSoftDrop4CaloJetBtagging = cms.Sequence(
#     akPuSoftDrop4CaloJetBtaggingIP
#     *
...
akPuSoftDrop4CalopatJetsWithBtagging = patJets.clone(
    jetSource              = cms.InputTag("akPuSoftDrop4CaloJets"),
...
#         cms.InputTag("akPuSoftDrop4CaloSimpleSecondaryVertexHighEffBJetTags"),
...
# akPuSoftDrop4CalopatJetsWithBtagging.userData.userFloats.src += [
#     'akPuSoftDrop4CaloNjettiness:tau1',
#     'akPuSoftDrop4CaloNjettiness:tau2',
#     'akPuSoftDrop4CaloNjettiness:tau3'
# ]

akPuSoftDrop4CaloJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPuSoftDrop4CalopatJetsWithBtagging"),
...
akPuSoftDrop4CaloJetSequence_mc = cms.Sequence(
    ...
    *
    ...
    # akPuSoftDrop4CaloPatJetFlavourId
    # *
...
akPuSoftDrop4CaloJetSequence_data = cms.Sequence(
    akPuSoftDrop4Calocorr
    *
    # akPuSoftDrop4CaloJetID
    # *
...
akPuSoftDrop4CaloJetSequence_jec = cms.Sequence(
    akPuSoftDrop4CaloJetSequence_mc)
akPuSoftDrop4CaloJetSequence_mb = cms.Sequence(
    akPuSoftDrop4CaloJetSequence_mc)

akPuSoftDrop4CaloJetSequence = cms.Sequence(
    akPuSoftDrop4CaloJetSequence_mb)

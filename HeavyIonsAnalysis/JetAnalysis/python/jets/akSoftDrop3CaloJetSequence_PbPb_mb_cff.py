...
# akSoftDrop3Caloparton = patJetPartonMatch.clone(
#     src = cms.InputTag("akSoftDrop3CaloJets")
# )
...
akSoftDrop3CaloJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akSoftDrop3CaloJets'))

# akSoftDrop3Caloclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak3HiCleanedGenJets'))

# akSoftDrop3CalobTagger = bTaggers(
#     "akSoftDrop3Calo", 0.3)
...
# akSoftDrop3CaloPatJetFlavourId = cms.Sequence(
#     akSoftDrop3CaloPatJetPartons
#     *
#     akSoftDrop3CaloPatJetFlavourAssociation)

# akSoftDrop3CaloJetBtaggingIP  = cms.Sequence(
#     akSoftDrop3CaloImpactParameterTagInfos *
...
# akSoftDrop3CaloJetBtaggingSV = cms.Sequence(
#     akSoftDrop3CaloImpactParameterTagInfos
#     *
...
# )
# 
# akSoftDrop3CaloJetBtaggingNegSV = cms.Sequence(
#     akSoftDrop3CaloImpactParameterTagInfos
#     *
...
# )
# 
# akSoftDrop3CaloJetBtaggingMu = cms.Sequence(
#     akSoftDrop3CaloSoftPFMuonsTagInfos
#     *
#     akSoftDrop3CaloSoftPFMuonBJetTags
#     +
...
# )
# 
# akSoftDrop3CaloJetBtagging = cms.Sequence(
#     akSoftDrop3CaloJetBtaggingIP
#     *
...
akSoftDrop3CalopatJetsWithBtagging = patJets.clone(
    jetSource              = cms.InputTag("akSoftDrop3CaloJets"),
...
#         cms.InputTag("akSoftDrop3CaloSimpleSecondaryVertexHighEffBJetTags"),
...
# akSoftDrop3CalopatJetsWithBtagging.userData.userFloats.src += [
#     'akSoftDrop3CaloNjettiness:tau1',
#     'akSoftDrop3CaloNjettiness:tau2',
#     'akSoftDrop3CaloNjettiness:tau3'
# ]

akSoftDrop3CaloJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akSoftDrop3CalopatJetsWithBtagging"),
...
akSoftDrop3CaloJetSequence_mc = cms.Sequence(
    ...
    *
    ...
    # akSoftDrop3CaloPatJetFlavourId
    # *
...
akSoftDrop3CaloJetSequence_data = cms.Sequence(
    akSoftDrop3Calocorr
    *
    # akSoftDrop3CaloJetID
    # *
...
akSoftDrop3CaloJetSequence_jec = cms.Sequence(
    akSoftDrop3CaloJetSequence_mc)
akSoftDrop3CaloJetSequence_mb = cms.Sequence(
    akSoftDrop3CaloJetSequence_mc)

akSoftDrop3CaloJetSequence = cms.Sequence(
    akSoftDrop3CaloJetSequence_mb)

...
# akSoftDrop2Caloparton = patJetPartonMatch.clone(
#     src = cms.InputTag("akSoftDrop2CaloJets")
# )
...
akSoftDrop2CaloJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akSoftDrop2CaloJets'))

# akSoftDrop2Caloclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak2HiCleanedGenJets'))

# akSoftDrop2CalobTagger = bTaggers(
#     "akSoftDrop2Calo", 0.2)
...
# akSoftDrop2CaloPatJetFlavourId = cms.Sequence(
#     akSoftDrop2CaloPatJetPartons
#     *
#     akSoftDrop2CaloPatJetFlavourAssociation)

# akSoftDrop2CaloJetBtaggingIP  = cms.Sequence(
#     akSoftDrop2CaloImpactParameterTagInfos *
...
# akSoftDrop2CaloJetBtaggingSV = cms.Sequence(
#     akSoftDrop2CaloImpactParameterTagInfos
#     *
...
# )
# 
# akSoftDrop2CaloJetBtaggingNegSV = cms.Sequence(
#     akSoftDrop2CaloImpactParameterTagInfos
#     *
...
# )
# 
# akSoftDrop2CaloJetBtaggingMu = cms.Sequence(
#     akSoftDrop2CaloSoftPFMuonsTagInfos
#     *
#     akSoftDrop2CaloSoftPFMuonBJetTags
#     +
...
# )
# 
# akSoftDrop2CaloJetBtagging = cms.Sequence(
#     akSoftDrop2CaloJetBtaggingIP
#     *
...
akSoftDrop2CalopatJetsWithBtagging = patJets.clone(
    jetSource              = cms.InputTag("akSoftDrop2CaloJets"),
...
#         cms.InputTag("akSoftDrop2CaloSimpleSecondaryVertexHighEffBJetTags"),
...
# akSoftDrop2CalopatJetsWithBtagging.userData.userFloats.src += [
#     'akSoftDrop2CaloNjettiness:tau1',
#     'akSoftDrop2CaloNjettiness:tau2',
#     'akSoftDrop2CaloNjettiness:tau3'
# ]

akSoftDrop2CaloJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akSoftDrop2CalopatJetsWithBtagging"),
...
akSoftDrop2CaloJetSequence_mc = cms.Sequence(
    ...
    *
    ...
    # akSoftDrop2CaloPatJetFlavourId
    # *
...
akSoftDrop2CaloJetSequence_data = cms.Sequence(
    akSoftDrop2Calocorr
    *
    # akSoftDrop2CaloJetID
    # *
...
akSoftDrop2CaloJetSequence_jec = cms.Sequence(
    akSoftDrop2CaloJetSequence_mc)
akSoftDrop2CaloJetSequence_mb = cms.Sequence(
    akSoftDrop2CaloJetSequence_mc)

akSoftDrop2CaloJetSequence = cms.Sequence(
    akSoftDrop2CaloJetSequence_mb)

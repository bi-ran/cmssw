...
# akPuSoftDrop2Caloparton = patJetPartonMatch.clone(
#     src = cms.InputTag("akPuSoftDrop2CaloJets")
# )
...
akPuSoftDrop2CaloJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPuSoftDrop2CaloJets'))

# akPuSoftDrop2Caloclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak2HiCleanedGenJets'))

# akPuSoftDrop2CalobTagger = bTaggers(
#     "akPuSoftDrop2Calo", 0.2)
...
# akPuSoftDrop2CaloPatJetFlavourId = cms.Sequence(
#     akPuSoftDrop2CaloPatJetPartons
#     *
#     akPuSoftDrop2CaloPatJetFlavourAssociation)

# akPuSoftDrop2CaloJetBtaggingIP  = cms.Sequence(
#     akPuSoftDrop2CaloImpactParameterTagInfos *
...
# akPuSoftDrop2CaloJetBtaggingSV = cms.Sequence(
#     akPuSoftDrop2CaloImpactParameterTagInfos
#     *
...
# )
# 
# akPuSoftDrop2CaloJetBtaggingNegSV = cms.Sequence(
#     akPuSoftDrop2CaloImpactParameterTagInfos
#     *
...
# )
# 
# akPuSoftDrop2CaloJetBtaggingMu = cms.Sequence(
#     akPuSoftDrop2CaloSoftPFMuonsTagInfos
#     *
#     akPuSoftDrop2CaloSoftPFMuonBJetTags
#     +
...
# )
# 
# akPuSoftDrop2CaloJetBtagging = cms.Sequence(
#     akPuSoftDrop2CaloJetBtaggingIP
#     *
...
akPuSoftDrop2CalopatJetsWithBtagging = patJets.clone(
    jetSource              = cms.InputTag("akPuSoftDrop2CaloJets"),
...
#         cms.InputTag("akPuSoftDrop2CaloSimpleSecondaryVertexHighEffBJetTags"),
...
# akPuSoftDrop2CalopatJetsWithBtagging.userData.userFloats.src += [
#     'akPuSoftDrop2CaloNjettiness:tau1',
#     'akPuSoftDrop2CaloNjettiness:tau2',
#     'akPuSoftDrop2CaloNjettiness:tau3'
# ]

akPuSoftDrop2CaloJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPuSoftDrop2CalopatJetsWithBtagging"),
...
akPuSoftDrop2CaloJetSequence_mc = cms.Sequence(
    ...
    *
    ...
    # akPuSoftDrop2CaloPatJetFlavourId
    # *
...
akPuSoftDrop2CaloJetSequence_data = cms.Sequence(
    akPuSoftDrop2Calocorr
    *
    # akPuSoftDrop2CaloJetID
    # *
...
akPuSoftDrop2CaloJetSequence_jec = cms.Sequence(
    akPuSoftDrop2CaloJetSequence_mc)
akPuSoftDrop2CaloJetSequence_mb = cms.Sequence(
    akPuSoftDrop2CaloJetSequence_mc)

akPuSoftDrop2CaloJetSequence = cms.Sequence(
    akPuSoftDrop2CaloJetSequence_mb)
